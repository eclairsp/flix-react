...
class Search extends React.Component {
    ...
    fetchSearchResults = () => {
        let urlSearch = `https://api.themoviedb.org/3/search/multi?api_key=74d9bb95f2c26a20a3f908c481d10af3&query=${this.state.query}&sort_by=popularity.asc`;
        ...
        return (
            <Hom>
                            ...
                            <div className="results-search">
                                {this.state.resultHead.map((val, index) => {
                                    return (
                                        ...
                                        >
                                            <div className="card-after-result">
                                                <LazyLoadImage
                ...
                <section className="no-result-wrapper">
                    ...
                    <svg data-name="Layer 1" version="1.1" viewBox="0 0 695.07 581.27" xmlns="http://www.w3.org/2000/svg" cc="http://creativecommons.org/ns#" dc="http://purl.org/dc/elements/1.1/" rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xlink="http://www.w3.org/1999/xlink">
                        <defs>
                        ...
                        <path d="m225.43 421.45s76.92 163.27 299.44 111.86c0 0-23.55-20.41 0-47.88l-186.41-81.24z" fill="url(#c)"/>
                        <path d="m232.53 423.94s73.27 155.52 285.24 106.54c0 0-22.43-19.44 0-45.61l-177.58-77.38z" fill="#ff5252"/>
                        <circle cx="262.44" cy="262.44" r="178.7" fill="url(#h)"/>
                        <circle cx="262.44" cy="262.44" r="171.23" fill="#ff5252"/>
                        <path d="m262.44 0c-144.94 0-262.44 117.5-262.44 262.44s117.5 262.44 262.44 262.44 262.44-117.5 262.44-262.44-117.5-262.44-262.44-262.44zm95.57 137.05a60.8 60.8 0 1 1-22.26 83.07 60.8 60.8 0 0 1 22.26-83.06zm-191.14 250.77a60.8 60.8 0 1 1 22.25-83.05 60.8 60.8 0 0 1-22.25 83.05zm22.25-167.7a60.8 60.8 0 1 1-22.25-83.05 60.8 60.8 0 0 1 22.25 83.05zm73.31 248.58a60.8 60.8 0 1 1 60.8-60.8 60.8 60.8 0 0 1-60.79 60.79zm-38.47-209.34a38.48 38.48 0 1 1 38.48 38.48 38.48 38.48 0 0 1-38.48-38.48zm38.48-81.58a60.8 60.8 0 1 1 60.8-60.8 60.8 60.8 0 0 1-60.8 60.8zm178.62 187.78a60.8 60.8 0 1 1-22.25-83.05 60.8 60.8 0 0 1 22.25 83.05z" fill="url(#e)"/>
                        <path d="m262.44 7.48c-140.81 0-255 114.15-255 255s114.15 255 255 255 255-114.15 255-255-114.19-255-255-255zm92.85 133.15a59.07 59.07 0 1 1-21.62 80.69 59.07 59.07 0 0 1 21.61-80.69zm-185.7 243.62a59.07 59.07 0 1 1 21.6-80.69 59.07 59.07 0 0 1-21.6 80.69zm21.6-162.94a59.07 59.07 0 1 1-21.62-80.69 59.07 59.07 0 0 1 21.62 80.69zm71.23 241.5a59.07 59.07 0 1 1 59.07-59.07 59.07 59.07 0 0 1-59.05 59.08zm-37.37-203.36a37.38 37.38 0 1 1 37.38 37.38 37.38 37.38 0 0 1-37.38-37.38zm37.38-79.25a59.07 59.07 0 1 1 59.07-59.08 59.07 59.07 0 0 1-59.06 59.07zm173.54 182.43a59.07 59.07 0 1 1-21.62-80.69 59.07 59.07 0 0 1 21.62 80.69z" fill="#e6e6e6"/>
                        <path d="m24.68 277.39c0-140.81 114.15-255 255-255a253.79 253.79 0 0 1 148.18 47.47 253.93 253.93 0 0 0-165.38-60.93c-140.81 0-255 114.15-255 255a254.63 254.63 0 0 0 106.78 207.49 254.38 254.38 0 0 1-89.58-194.03z" fill="#fff" opacity=".2"/>
                        <circle cx="262.44" cy="259.44" r="42.99" fill="none" opacity=".2" stroke="#fff" strokeMiterlimit="10" strokeWidth="13"/>
                        ...
                        <rect x="486.86" y="279.07" width="199.3" height="19.44" fill="#ff5252"/>
                    ...
                    <h1 className="no-result-head color-orange">
                        Search for Movies, TV and celebs
                    </h1>
                </section>)}
            </Hom>
        );
